...
```text
Search_engine_productSimilarity/
├── Dataset/                     # Folder containing dataset files
├── Extraction_Features.ipynb    # Notebook for extracting features from product data
├── featurevector.pkl           # Serialized feature vectors
├── filenames.pkl               # Product filenames list
├── main.py                     # Main search engine application
